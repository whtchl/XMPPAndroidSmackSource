...
public class SmackImpl implements Smack {
	...
	static void registerSmackProviders() {
        ...
        Log.d("tchl","============XEP-0199 urn:xmpp:ping========");
		...
		/*DiscoverInfo.Identity identity = new DiscoverInfo.Identity(ServiceDiscoveryManager.DEFAULT_IDENTITY_CATEGORY,
                                                               ServiceDiscoveryManager.DEFAULT_IDENTITY_NAME,
                                                               ServiceDiscoveryManager.DEFAULT_IDENTITY_TYPE );*/
	...
	private void registerMessageSendFailureListener() {
       ...
       // mXMPPConnection.addPacketSendingListener();
        //tchl begin 0816
